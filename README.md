...
## How To Run
<p>For some running examples you can checkout the ![examples](CGEO/tree/main/examples) directory which has some cool examples for each class and algorithm. And you can also run each one of it by yourself.
