...
namespace Algorithms2d{
    ...
    public:
        ...
        static void
        intersect(std::pair<bool, Shapes2D::Point2d *> * intersectionPair,
                  Shapes2D::Segment2d& a,
        ...
        __attribute__((unused)) static void print_status(SegmentBalancedTree *status);

        __attribute__((unused)) static void print_events(std::multimap<Shapes2D::Point2d, int, event_comp> *events);
